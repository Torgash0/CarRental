    ...
    public partial class Migrations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RentEntityCarEntity", x => new { x.RentsId, x.CarsId });
                    table.ForeignKey(
                        name: "FK_RentEntityCarEntity_rents_RentsId",
                        column: x => x.RentsId,
                        principalTable: "rents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RentEntityCarEntity_Cars_CarsId",
                        column: x => x.CarsId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RentEntityCarEntity_CarsId",
                table: "RentEntityCarEntity",
                column: "CarsId");
